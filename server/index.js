...
import joobleRoutes from "./routes/jooble.js";
...
app.listen(PORT, () => {
  ...
  if (!process.env.ANTHROPIC_API_KEY) console.warn("⚠️  No ANTHROPIC_API_KEY set.");
  if (!process.env.JOOBLE_API_KEY) console.warn("⚠️  No JOOBLE_API_KEY set.");
  if (!process.env.ADZUNA_APP_ID) console.warn("⚠️  No ADZUNA_APP_ID set.");
});
